...
3. Install dependencies:
   ...
   npm install
   ```
4. Configure environment variables in `.env` (database credentials, JWT secret, email config).
5. Start the server:
...
*Add screenshots of the user dashboard, admin panel, and product pages here.*
